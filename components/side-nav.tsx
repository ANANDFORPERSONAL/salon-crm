      ...
      <div className="flex h-full flex-col gap-2 p-4">
        ...
        <div className="flex h-16 items-center border-b border-gray-200 px-4 mb-4">
          <Link href="/" className="flex items-center gap-3 font-bold text-lg group">
            <div className="p-2 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
        ...
        <div className="border-t border-gray-200 pt-4 mt-auto">
          <div className="px-4 py-3 bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl">
